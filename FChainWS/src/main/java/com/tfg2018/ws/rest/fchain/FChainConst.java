...
public class FChainConst {
    ...
    public static String MULTICHAIN_SERVER_PWD = "CarvWuai2CiLgQFRqx2cx9wfDSLSyDKQ6DzLLK2n3JvY";
    public static String ISSUANCE_ADDRESS = "1Hak78TRcvJy7MswUpqJvLnRjgx6AxSMYpVmW4";
}
